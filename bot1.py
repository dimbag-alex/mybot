...
def help_message(message):
    bot.send_message(message.chat.id, "Я могу узнать курс пяти самых торгуемых "
                                      ...
                                      "а также вывести статистику по коронавирусу для некоторых стран СНГ, а так же"
                                      " США и Китая")

    bot.send_message(message.chat.id, "Для того, что бы узнать курс валюты, просто напишите ее название(например, евро)"
                                      " и я выведу ее курс к рублю, основываясь на данных ЦБ РФ. Что бы узнать погоду"
